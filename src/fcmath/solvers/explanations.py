...
from fcmath.settings import DEFAULT_OPENAI_MODEL, get_settings

if TYPE_CHECKING:
    from fcmath.solvers.models import EquationSolution
...
class OpenAIEquationExplanationClient:
    ...
    The math is still produced and verified locally by SymPy/fcmath. This
