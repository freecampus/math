...
execute:
  echo: false
id: differential-equations-ordinary-differential-equations-linear-equations
...
Use `fcmath` to generate integrating-factor practice.

```{python}
#| echo: true
from fcmath.differential_equations import linear_integrating_factor_exercise
