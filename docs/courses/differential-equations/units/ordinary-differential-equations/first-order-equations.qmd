...
execute:
  echo: false
id: differential-equations-ordinary-differential-equations-first-order-equations
course_id: differential-equations
unit_id: ordinary-differential-equations
page_type: lesson
status: active
estimated_time: "60 minutes"
skill_modes: [conceptual, manual-calculation, computational, interpretation]
outcome_ids: [differential-equations-outcome-1, differential-equations-outcome-2, differential-equations-outcome-4]
---
...
<script type="application/json" class="fcmath-de-checkpoint-config">
{
...
```{python}
#| echo: true
from fcmath.differential_equations import validate_solution_satisfies_ode
