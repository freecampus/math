...
execute:
  echo: false
id: differential-equations-ordinary-differential-equations-systems
...
outcome_ids: [differential-equations-outcome-1, differential-equations-outcome-2, differential-equations-outcome-3, differential-equations-outcome-4]
---
...
Use `fcmath` to approximate a simple system numerically.

```{python}
#| echo: true
from fcmath.differential_equations import system_euler_method
