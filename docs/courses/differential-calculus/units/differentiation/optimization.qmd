...
execute:
  echo: false
id: differential-calculus-differentiation-optimization
...
- use SymPy and `fcmath` to compute and compare candidates.
:::
...
```{python}
#| echo: true
from fcmath.calculus import optimization_candidate_table, validate_critical_points
