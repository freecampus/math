...
execute:
  echo: false
id: differential-calculus-differentiation-derivative-rules
...
outcome_ids: [differential-calculus-outcome-2, differential-calculus-outcome-4]
---
...
- check derivatives with SymPy and `fcmath` validators.
:::
...
```{python}
#| echo: true
from fcmath.calculus import derivative, derivative_rule_trace, validate_derivative_equivalence
