...
- use `fcmath` and SymPy to check computations responsibly.
:::
...
5. check with SymPy or `fcmath` only after trying.
...
```{python}
#| echo: true
from fcmath.calculus import derivative, tangent_line, definite_integral
...
```{python}
#| echo: true
from fcmath.calculus import calculus_tool_question
