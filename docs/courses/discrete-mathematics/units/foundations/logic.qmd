...
execute:
  echo: false
id: discrete-mathematics-foundations-logic
course_id: discrete-mathematics
unit_id: foundations
page_type: lesson
status: active
estimated_time: "55 minutes"
skill_modes: [conceptual, manual-calculation, computational, symbolic-reasoning]
outcome_ids: [discrete-mathematics-outcome-1, discrete-mathematics-outcome-2, discrete-mathematics-outcome-4]
---
...
```{python}
#| echo: true
from fcmath.discrete_math import implies, is_tautology, truth_table_rows
