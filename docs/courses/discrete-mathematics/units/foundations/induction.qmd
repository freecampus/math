...
execute:
  echo: false
id: discrete-mathematics-foundations-induction
...
outcome_ids: [discrete-mathematics-outcome-2, discrete-mathematics-outcome-4]
---
...
```{python}
#| echo: true
from fcmath.discrete_math import induction_step_exercise
