...
execute:
  echo: false
id: integral-calculus-integration-applications
...
- use SymPy and `fcmath` helpers to check applied calculations.
:::
...
```{python}
#| echo: true
from fcmath.calculus import derivative, definite_integral
...
```{python}
#| echo: true
from fcmath.calculus import calculus_application_tool_choice_exercise
