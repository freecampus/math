...
execute:
  echo: false
id: advanced-algebra-trigonometry-trig-equations
...
outcome_ids: [advanced-algebra-outcome-3, advanced-algebra-outcome-4]
---
...
Use `fcmath` for angle facts and SymPy for algebraic verification. SymPy can
solve many equations, but interval reasoning is still easier when you understand
the unit circle.

```{python}
#| echo: true
from fcmath.trigonometry import reference_angle_degrees, trig_signs
