...
execute:
  echo: false
id: advanced-algebra-trigonometry-unit-circle
...
outcome_ids: [advanced-algebra-outcome-2, advanced-algebra-outcome-4]
---
...
Use `fcmath` to find quadrants, signs, and special-angle values.

```{python}
#| echo: true
from fcmath.trigonometry import quadrant, special_angle_values, trig_signs
...
```{python}
#| echo: true
#| fig-alt: "Unit circle with a radius at 150 degrees and its cosine and sine coordinates."
from fcmath.trigonometry import plot_unit_circle
