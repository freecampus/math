...
execute:
  echo: false
id: advanced-algebra-trigonometry-sine-cosine
...
outcome_ids: [advanced-algebra-outcome-4]
---
...
Use `fcmath` to compute a unit-circle point.

```{python}
#| echo: true
from fcmath.trigonometry import plot_unit_circle, special_angle_values, unit_circle_point
...
```{python}
#| echo: true
#| fig-alt: "Unit circle with a radius at 30 degrees and its cosine and sine coordinates."
