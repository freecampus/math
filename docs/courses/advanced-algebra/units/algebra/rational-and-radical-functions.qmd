...
execute:
  echo: false
id: advanced-algebra-algebra-rational-and-radical-functions
...
```{python}
#| fig-alt: "Graphs comparing three rational expressions with shifted asymptotic and simplified linear behavior."
