...
execute:
  echo: false
id: advanced-algebra-algebra-symbolic-computation-with-sympy
...
outcome_ids: [advanced-algebra-outcome-1, advanced-algebra-outcome-3, advanced-algebra-outcome-5]
---
...
```{python}
#| echo: true
#| fig-alt: "Graph of the quadratic x squared minus 3x plus 2 over the displayed input range."
