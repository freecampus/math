...
execute:
  echo: false
id: advanced-algebra-algebra-systems-of-equations
...
outcome_ids: [advanced-algebra-outcome-3, advanced-algebra-outcome-5]
---
...
```{python}
#| fig-alt: "Lines y equals x plus 1 and y equals negative x plus 5 intersecting at 2 comma 3."
