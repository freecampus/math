...
execute:
  echo: false
id: statistics-foundations-hypothesis-tests
...
Use `fcmath` for z statistics and normal-approximation p-values.

```{python}
#| echo: true
from fcmath.statistics import one_sample_z_test, z_test_statistic
