...
execute:
  echo: false
id: statistics-foundations-regression-basics
...
Use `fcmath` to fit a simple regression line and compute residuals.

```{python}
#| echo: true
from fcmath.statistics import predict, residuals, simple_linear_regression
