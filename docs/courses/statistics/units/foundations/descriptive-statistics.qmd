...
execute:
  echo: false
id: statistics-foundations-descriptive-statistics
...
outcome_ids: [statistics-outcome-3, statistics-outcome-4]
---
...
- use `fcmath`, Python, and SymPy to verify descriptive calculations.
:::
...
Use `fcmath` to compute descriptive summaries.

```{python}
#| echo: true
from fcmath.statistics import describe, five_number_summary, outlier_fences
