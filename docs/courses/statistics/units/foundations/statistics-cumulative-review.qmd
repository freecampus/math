...
execute:
  echo: false
id: statistics-foundations-statistics-cumulative-review
...
outcome_ids: [statistics-outcome-1, statistics-outcome-2, statistics-outcome-3, statistics-outcome-4]
---
...
Use `fcmath` helpers to connect the workflow.
