...
execute:
  echo: false
id: statistics-foundations-chi-square-tests
course_id: statistics
unit_id: foundations
page_type: lesson
status: active
estimated_time: "55 minutes"
skill_modes: [conceptual, manual-calculation, computational, interpretation, symbolic-reasoning]
outcome_ids: [statistics-outcome-2, statistics-outcome-3, statistics-outcome-4]
---
