...
execute:
  echo: false
id: statistics-foundations-estimation
...
- use `fcmath` to verify confidence interval calculations.
:::
...
Use `fcmath` to compute confidence intervals.

```{python}
#| echo: true
from fcmath.statistics import confidence_interval_mean, confidence_interval_proportion
