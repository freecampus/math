...
execute:
  echo: false
id: statistics-foundations-comparing-groups
...
Use `fcmath` to compute a standard error for a difference of independent means.

```{python}
#| echo: true
from fcmath.statistics import difference_standard_error
