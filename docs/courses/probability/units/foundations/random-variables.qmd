...
execute:
  echo: false
id: probability-foundations-random-variables
...
- use Python, `fcmath`, and SymPy to check probability tables.
:::
...
Use `fcmath` to compute expected value.

```{python}
#| echo: true
from fcmath.probability import expected_value, validate_pmf
