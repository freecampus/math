...
execute:
  echo: false
id: probability-foundations-sample-spaces-events
...
- check finite event calculations with Python, `fcmath`, and SymPy.
:::
...
Use `fcmath` to compute probabilities from finite equally likely outcomes.

```{python}
#| echo: true
from fcmath.probability import complement, probability
